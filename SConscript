...
#  env.Append(LIBPATH=["MLFoundation", "MLFoundation/libpcre"], CPPPATH=["MLFoundation/Headers"], LIBS=["ml-base", "pcre"])
  env.Append(LIBPATH=["MLFoundation", "MLFoundation/libpcre"], CPPPATH=["MLFoundation/Headers"], LIBS=["pcre"])
  env.Append(CCFLAGS="-x objective-c -MMD -MP -DGNUSTEP -DGNUSTEP_BASE_LIBRARY=1 -DGNU_GUI_LIBRARY=1 -DGNU_RUNTIME=1 -DGNUSTEP_BASE_LIBRARY=1 -fno-strict-aliasing -fexceptions -fobjc-exceptions -D_NATIVE_OBJC_EXCEPTIONS -fPIC -Wall -DGSWARN -DGSDIAGNOSE -g -O2 -fgnu-runtime -fconstant-string-class=NSConstantString -I. -I/home/skudryas/GNUstep/Library/Headers -I/usr/local/include/GNUstep -I/usr/include/GNUstep -Wno-unused-result -Wno-implicit-function-declaration -Wno-unused-variable -fno-inline-small-functions")
  env.Append(OBJCFLAGS="-x objective-c -MMD -MP -DGNUSTEP -DGNUSTEP_BASE_LIBRARY=1 -DGNU_GUI_LIBRARY=1 -DGNU_RUNTIME=1 -DGNUSTEP_BASE_LIBRARY=1 -fno-strict-aliasing -fexceptions -fobjc-exceptions -D_NATIVE_OBJC_EXCEPTIONS -fPIC -Wall -DGSWARN -DGSDIAGNOSE -g -O2 -fgnu-runtime -fconstant-string-class=NSConstantString -I. -I/home/skudryas/GNUstep/Library/Headers -I/usr/local/include/GNUstep -I/usr/include/GNUstep -Wno-unused-result -Wno-implicit-function-declaration -Wno-unused-variable -fno-inline-small-functions")
...
if (debug != None and int(debug)) or (debug == None and int(DEFAULT_DEBUG)):
	evCoreEnv.Replace(OBJCFLAGS="-x objective-c -MMD -MP -DGNUSTEP -DGNUSTEP_BASE_LIBRARY=1 -DGNU_GUI_LIBRARY=1 -DGNU_RUNTIME=1 -DGNUSTEP_BASE_LIBRARY=1 -fno-strict-aliasing -fexceptions -fobjc-exceptions -D_NATIVE_OBJC_EXCEPTIONS -fPIC -Wall -DGSWARN -DGSDIAGNOSE -Wno-import -g -O2 -fgnu-runtime -fconstant-string-class=NSConstantString -I. -I/home/skudryas/GNUstep/Library/Headers -I/usr/local/include/GNUstep -I/usr/include/GNUstep -O0 -g -Wno-unused-result -Wno-implicit-function-declaration -Wno-unused-variable -fno-inline-small-functions")
	evCoreEnv.Replace(CCFLAGS="-O0 -g -w")
else:
	evCoreEnv.Replace(OBJCFLAGS="-x objective-c -MMD -MP -DGNUSTEP -DGNUSTEP_BASE_LIBRARY=1 -DGNU_GUI_LIBRARY=1 -DGNU_RUNTIME=1 -DGNUSTEP_BASE_LIBRARY=1 -fno-strict-aliasing -fexceptions -fobjc-exceptions -D_NATIVE_OBJC_EXCEPTIONS -fPIC -Wall -DGSWARN -DGSDIAGNOSE -Wno-import -g -O2 -fgnu-runtime -fconstant-string-class=NSConstantString -I. -I/home/skudryas/GNUstep/Library/Headers -I/usr/local/include/GNUstep -I/usr/include/GNUstep -O3 -Wno-unused-result -Wno-implicit-function-declaration -Wno-unused-variable -fno-inline-small-functions")
...
env.Append(LIBS = ['gnustep-base', 'pthread', 'objc', 'm'])
myProgSources = ['keyval/main.m', 'keyval/kvAcceptDelegator.m', 'keyval/kvStreamDelegator.m', 'keyval/kvFormatParser.m' ]

myProg = env.Program('my_prog', [myProgSources, mlBase])
env.Depends(myProg, [mlBase])
